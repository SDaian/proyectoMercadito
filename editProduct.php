...
if(isset($_GET['id'])){
  $pro = sistema\controladorBD::getProductoById($_GET['id']);
}
...
if (isset($_POST['submit'])) {
   if((!empty($_POST['nombre'])) && (!empty($_POST['descripcion'])) && (!empty($_POST['precio']))){
    ...
    //leer el archivo temporal en binario
        ...
        $sql = \sistema\controladorBD::updateProducto($post);
        $pro = sistema\controladorBD::getProductoById($_GET['id']);
        if($sql){
            echo "<style>
                        #success{
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="nombre" id="InputName" value="<?php echo $pro->getNombre(); ?>" placeholder="Nombre del producto">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea class="form-control" id="InputDescripcion" name="descripcion" rows="3" placeholder="Breve descripcion del producto"> <?php echo htmlspecialchars($pro->getDescripcion()); ?></textarea>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <?php
                    ...
                    foreach ($categorias as $s) {
                      if($pro->getIdCategoria()== $s->getId()){
                            echo "<option selected='selected'> ". $s->getId(). " - " . $s->getNombre()."</option>";
                      }else{
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="InputPrecio" name="precio" value="<?php echo $pro->getPrecio(); ?>" placeholder="Precio del producto">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-lg-5 col-md-push-1">
            <div class="col-md-12">
                ...
                <div class="alert alert-success see" id="success">
                    <strong><span class="glyphicon glyphicon-ok"></span> Su producto ha sido actualizado correctamente.</strong>
                </div>
