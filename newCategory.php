   ...
   if((!empty($_POST['nombrecategoria']))){
    if (isset($_POST['nombrecategoria'])) {
        if (\sistema\controladorBD::comprobarCategoria($_POST['nombrecategoria']) != null) {
          $categoria = \sistema\controladorBD::crearCategoria($_POST['nombrecategoria']);
          if ($categoria == null) {
              echo "<style>
              #nameerrortwo{
                  display:block;
...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="col-lg-5 col-md-push-1">
              <div class="col-md-12">
                  ...
                  <div class="alert alert-info" id="namegood">
                      <strong><span class="glyphicon glyphicon-ok"></span> Categoria creada.</strong>
                  </div>
              </div>
      </div>
      <div class="row">
          ...
          <form method="post" action="" onSubmit="return validarCategoria()" role="login" name="formcategoria">
            <input type="text" name="nombrecategoria" placeholder="Ingrese nueva categoria"  class="form-control input-lg">
